...
if (isset($_POST['lookup_add_btn'])) {
    ...
    if ($name === '') {
        ...
        $errmsg = 'that fuel type already exists.';
    } else {
...
if (isset($_POST['lookup_update_btn'])) {
    ...
    if (is_numeric($id) && $name !== '') {
        if (Lookup::nameExists($table, $name, $id)) {
            $errmsg = 'Another fuel type already has that name.';
        } else {
...
if (isset($_POST['lookup_delete_btn'])) {
    ...
    if (is_numeric($id)) {
        ...
        CommonBase::SendRedirect('fueltype_manager.php');
        exit;
    }
}
        ...
        <div id="wrapper">
            ...
            <div id="content" class="clearfix">
                <div class="contentwrapper">
                    ...
                    <div class="heading">
                        <h3>Fuel Type Manager</h3>
                        <ul class="breadcrumb">
                            <li>You are here:</li>
                            <li>Vehicle Attributes</li>
                            <li class="active">Fuel Type Manager</li>
                        </ul>
                    </div>
                    ...
                    <div class="row-fluid">
                        <div class="span4">
                            <div class="admin-card">
                                <h4 style="margin-top:0;"><?= $editRow ? 'Edit Fuel Type' : 'Add New Fuel Type' ?></h4>
                                ...
                                <form method="post">
                                    ...
                                    <button type="submit" name="<?= $editRow ? 'lookup_update_btn' : 'lookup_add_btn' ?>" class="btn btn-admin-primary">
                                        <?= $editRow ? 'Update' : 'Add Fuel Type' ?>
                                    </button>
                                    <?php if ($editRow): ?>
                                    <a href="fueltype_manager.php" class="btn">Cancel</a>
                                    <?php endif; ?>
                                </form>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="post" style="display:inline" onsubmit="return confirm('Delete this fuel type?')">
