...
if (isset($_POST['lookup_add_btn'])) {
    ...
    if ($name === '') {
        ...
        $errmsg = 'That make already exists.';
    } else {
...
if (isset($_POST['lookup_update_btn'])) {
    ...
    if (is_numeric($id) && $name !== '') {
        if (Lookup::nameExists($table, $name, $id)) {
            $errmsg = 'Another make already has that name.';
        } else {
...
if (isset($_POST['lookup_delete_btn'])) {
    ...
    if (is_numeric($id)) {
        ...
        CommonBase::SendRedirect('make_manager.php');
        exit;
    }
}
                ...
                <div class="contentwrapper">
                    ...
                    <div class="heading">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Make Manager</li>
                        </ul>
                    </div>
                    ...
                    <div class="row-fluid">
                        <div class="span4">
                            <div class="admin-card">
                                <h4 style="margin-top:0;"><?= $editRow ? 'Edit Make' : 'Add New Make' ?></h4>
                                ...
                                <form method="post">
                                    ...
                                    <button type="submit" name="<?= $editRow ? 'lookup_update_btn' : 'lookup_add_btn' ?>" class="btn btn-admin-primary">
                                        <?= $editRow ? 'Update' : 'Add Make' ?>
                                    </button>
                                    <?php if ($editRow): ?>
                                    <a href="make_manager.php" class="btn">Cancel</a>
                                    <?php endif; ?>
                                </form>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="post" style="display:inline" onsubmit="return confirm('Delete this make?')">
